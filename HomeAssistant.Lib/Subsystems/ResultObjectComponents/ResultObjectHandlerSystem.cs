...
namespace ResultObjectComponents
{
    ...
    {
        public ResultObjectHandlerSystem(Dictionary<string, string> @params, params Subsystem[] dependencies) :
        ...
        public override async Task TaskObject(CancellationToken cancellationToken)
        {
            ...
            switch (resultObject)
            {
                case ResultObjectTodoSystem todoSystem:
                    ...
                    await SubsystemPool.RunAsync(SubSystemFactory<TodoSystem>.Create(@params), cancellationToken);
                    break;
            }
