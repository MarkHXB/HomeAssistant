...
//var testMessager = async () =>
//{
//	Dictionary<string, string> @params = new()
//	{
//		{nameof(Messager.Params.PushBulletApiKey), config[$"Credentials:{nameof(Params.PushBulletApiKey)}"]},
//		{nameof(Messager.Params.GmailPasswordKey), config[$"Credentials:{nameof(Params.GmailPasswordKey)}"]},
//	};

//	var messagerSystem = SubSystemFactory<MessagerSystem>.Create(@params);

//	SubsystemPool.AddSubsystem(messagerSystem);

//	messagerSystem.CreateNotification(new NotificationObject("Test Subject", "Something meaningful goes here", NotificationTypes.PushBullet));
...
var nyxarion = async () =>
{
	var nyxarionSystem = SubSystemFactory<NyxarionSystem>.Create();
	nyxarionSystem.SetParameter<IEnumerable<string>>(Nyxarion.Params.FileLoggerFolderPathList, new List<string>
	{
		@"C:\Users\sasli\Downloads",
		@"C:\Users\sasli\Documents\AdvancedDebugging\vs-adv-debug-2823390"
	});

	SubsystemPool.AddSubsystem(nyxarionSystem);
